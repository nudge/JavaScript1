...
function validNumber(num) {
    ...
    if (creditCard.toString().length > 16 || creditCard.toString().length < 16) { //This if statement makes sure that there are 16 digits in the credit card number.
    ...
    } else if (creditCard.toString()[15] % 2 === 1) { //Checks the last digit with the remainder operator to make sure that it is even.
    ...
    } else if (allSameDigits(creditCard) === true) {
...
let creditCard = '4444444444444448';
